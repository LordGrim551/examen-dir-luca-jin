    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainLoginScreen.this, RegisterActivityMain.class);

                Pair[] pairs = new Pair[6];
                pairs[0] = new Pair<View, String>(logoLogin, "ryodanTrans2");
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(MainLoginScreen.this, pairs);
        ...
        forgotpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                View view1 = LayoutInflater.from(MainLoginScreen.this).inflate(R.layout.alert_dialog, null);
                MaterialAlertDialogBuilder pass_dialog = new MaterialAlertDialogBuilder(MainLoginScreen.this)
                        ...
                        .setPositiveButton("Thx :)", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int x) {
                                Toast.makeText(MainLoginScreen.this, "We have sent a password restore email", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        })
